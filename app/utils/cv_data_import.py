...
class ScrapeConfig:
    """"add docstring"""
    def __init__(self, locations, elements, scrape_mode):
...
class ScrapeCVFilmPage:
    ...
    def scrape_cv_film_data(self, soup, look_for_element):
